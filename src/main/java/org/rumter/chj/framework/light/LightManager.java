package org.rumter.chj.framework.light;
...
public class LightManager {
	...
	public void initLight0(Point startPosition) {
		l0Position = new float[] { startPosition.x - 4.4f, startPosition.y + 100, startPosition.z - 145.2f - 10, 0 };
		l0DrawPosition = new float[] { l0Position[0], l0Position[1] + 1, l0Position[2], 0 };
		...
		gl.glLighti(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_SPOT_CUTOFF, alpha);
		gl.glLightf(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_CONSTANT_ATTENUATION, attenuation);
		...
		gl.glLightfv(GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_POSITION, l0Position, 0);
