...
public class TrackSet extends SimpleModel {
	...
	private final float trackCoords[][][] = { { { 0, 0 }, { 0, 0 } }, { { -70, 29 }, { -293, 101 } },
			{ { -170, 62 }, { -302, 58 } }, { { -165, 119 }, { -204, 119 } }, { { -204, 119 }, { -244, 60 } },
			{ { -165, 152 }, { -293, 152 } }, { { -177, 152 }, { -265, 208 } }, { { -78, 200 }, { -202, 200 } },
			{ { -38, 256 }, { -293, 169 } }, { { -53, 254 }, { -180, 257 } }, { { -53, 250 }, { -53, 254 } },
			{ { -38, 256 }, { -38, 356 } }, { { -38, 313 }, { -178, 310 } }, { { -180, 257 }, { -178, 310 } },
			{ { -110, 198 }, { -128, 256 } }, { { -230, 80 }, { -234, 190 } }, { { -263, 59 }, { -265, 208 } },
			{ { -206, 114 }, { -293, 114 } }, { { -239, 114 }, { -265, 152 } }, { { -293, 102 }, { -293, 170 } },
			{ { -293, 101 }, { -419, 101 } }, { { -293, 119 }, { -406, 119 } }, { { -327, 151 }, { -410, 151 } },
			{ { -293, 170 }, { -418, 170 } }, { { -327, 101 }, { -327, 170 } }, { { -358, 101 }, { -358, 170 } },
			{ { -390, 101 }, { -390, 170 } } };

	private final float TRACK_1_WIDTH = 1.5f;
	private final float TRACK_2_WIDTH = 1f;
	/**
	...
	public TrackSet(float x, float y, float z) {
		...
		for (int i = 1; i <= TRACK_COUNT; ++i) {
			...
			Point vH = endCenter.sub(beginCenter);
			Point vW = vH.normal().rotateXZ(90).mul(width);

			Point p1 = beginCenter.sub(vW.mul(0.5f));
			Point p2 = p1.add(vH);
			Point p3 = p2.add(vW);
			Point p4 = p1.add(vW);
